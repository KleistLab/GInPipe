...
**Note:** paths to files should be absolute, or relative to he main pipeline Snakefile, or relative to the working directory (see below in Execution section) [CHECK!].
